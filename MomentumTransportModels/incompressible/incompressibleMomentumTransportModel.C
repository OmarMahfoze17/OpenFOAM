...
Foam::incompressibleMomentumTransportModel::mu() const
{
    ...
    return nu()*this->rho_;   //Omar: Add *this->rho_.
}
...
{
    return nu(patchi)*this->rho_; //Omar: Add *this->rho_.
}
...
{
    return nut()*this->rho_; //Omar: Add *this->rho_.
}
...
{
    return nut(patchi)*this->rho_; //Omar: Add *this->rho_.
}
...
{
    return nuEff()*this->rho_; //Omar: Add *this->rho_.
}
...
{
    return nuEff(patchi)*this->rho_; //Omar: Add *this->rho_. 
}
