...
void myKOmega2006<BasicMomentumTransportModel>::correctNut
(
...
template<class BasicMomentumTransportModel>
tmp<volScalarField::Internal> myKOmega2006<BasicMomentumTransportModel>::beta
(
    const volTensorField& gradU
) const
{
...
myKOmega2006<BasicMomentumTransportModel>::CDkOmega() const
{
    return max
    (
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix> myKOmega2006<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix> myKOmega2006<BasicMomentumTransportModel>::omegaSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicMomentumTransportModel>
myKOmega2006<BasicMomentumTransportModel>::myKOmega2006
(
...
template<class BasicMomentumTransportModel>
bool myKOmega2006<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void myKOmega2006<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    // surfaceScalarField alphaRhoPhi = this->alphaRhoPhi_*fvc::interpolate(rho);
    // surfaceScalarField phi = this->phi_*fvc::interpolate(rho);
    ...
    // tmp<surfaceScalarField> alphaRhoPhi1;
    // alphaRhoPhi1 =
    // (
    //     new surfaceScalarField
    //     (
    //         IOobject::groupName("alphaRhoPhi", alphaRhoPhi.group()),
    //         fvc::interpolate(rho)*alphaRhoPhi
    //     )
    // );
    // Update omega and G at the wall
    // const surfaceScalarField& rhoPhi_ = U.mesh().lookupObject<surfaceScalarField>("rhoPhi");
    // alphaRhoPhi=rhoPhi_;
