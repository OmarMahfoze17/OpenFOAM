...
void myRNGkEpsilon<BasicMomentumTransportModel>::correctNut()
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix> myRNGkEpsilon<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
myRNGkEpsilon<BasicMomentumTransportModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicMomentumTransportModel>
myRNGkEpsilon<BasicMomentumTransportModel>::myRNGkEpsilon
(
...
template<class BasicMomentumTransportModel>
bool myRNGkEpsilon<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void myRNGkEpsilon<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
